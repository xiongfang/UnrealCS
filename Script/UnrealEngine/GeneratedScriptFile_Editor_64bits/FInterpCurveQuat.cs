...
namespace UnrealEngine
{
	...
	{
		public TStructArray<FInterpCurvePointQuat> Points
		{
						get{ unsafe { fixed (void* p = &this) { return new TStructArray<FInterpCurvePointQuat>((FScriptArray)Marshal.PtrToStructure(new IntPtr(p)+0, typeof(FScriptArray)));}}}
