...
namespace UnrealEngine
{
	public partial class ANavigationTestingActor
	{
		...
		{
			get{ CheckIsValid(); IntPtr v = Marshal.ReadIntPtr(_this.Get() + EdRenderComp__Offset); if (v == IntPtr.Zero)return null; UNavTestRenderingComponent retValue = new UNavTestRenderingComponent(); retValue._this = v; return retValue; }
