...
{
	public partial class UMaterialExpressionTextureSampleParameter
	{
		...
		static UMaterialExpressionTextureSampleParameter()
		{
			IntPtr NativeClassPtr=GetNativeClassFromName("MaterialExpressionTextureSampleParameter");
