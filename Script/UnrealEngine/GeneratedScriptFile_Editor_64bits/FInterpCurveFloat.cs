...
namespace UnrealEngine
{
	...
	{
		public TStructArray<FInterpCurvePointFloat> Points
		{
						get{ unsafe { fixed (void* p = &this) { return new TStructArray<FInterpCurvePointFloat>((FScriptArray)Marshal.PtrToStructure(new IntPtr(p)+0, typeof(FScriptArray)));}}}
