...
namespace UnrealEngine
{
	...
	{
		public TStructArray<FInterpCurvePointVector> Points
		{
						get{ unsafe { fixed (void* p = &this) { return new TStructArray<FInterpCurvePointVector>((FScriptArray)Marshal.PtrToStructure(new IntPtr(p)+0, typeof(FScriptArray)));}}}
