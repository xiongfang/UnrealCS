...
namespace UnrealEngine
{
	...
	public partial struct FGPUSpriteResourceData
	{
		...
		{
						get{ unsafe { fixed (void* p = &this) { return new TStructArray<FColor>((FScriptArray)Marshal.PtrToStructure(new IntPtr(p)+12, typeof(FScriptArray)));}}}
		...
		{
						get{ unsafe { fixed (void* p = &this) { return new TStructArray<FColor>((FScriptArray)Marshal.PtrToStructure(new IntPtr(p)+24, typeof(FScriptArray)));}}}
