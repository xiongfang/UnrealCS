...
namespace UnrealEngine
{
	...
	{
		public TStructArray<FInterpCurvePointLinearColor> Points
		{
						get{ unsafe { fixed (void* p = &this) { return new TStructArray<FInterpCurvePointLinearColor>((FScriptArray)Marshal.PtrToStructure(new IntPtr(p)+0, typeof(FScriptArray)));}}}
