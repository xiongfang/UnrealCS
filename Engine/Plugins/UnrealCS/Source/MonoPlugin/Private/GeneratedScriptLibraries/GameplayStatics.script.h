...
namespace UnrealEngine
{
	class _UGameplayStatics
	{
		...
		static void ApplyDamage(UGameplayStatics* _this,AActor* DamagedActor,float BaseDamage,AController* EventInstigator,AActor* DamageCauser,TSubclassOf<UDamageType>  DamageTypeClass)
		{
			_this->ApplyDamage(DamagedActor,BaseDamage,EventInstigator,DamageCauser,DamageTypeClass);
			
		}
		static void ApplyPointDamage(UGameplayStatics* _this,AActor* DamagedActor,float BaseDamage,FVector* HitFromDirection,FHitResult* HitInfo,AController* EventInstigator,AActor* DamageCauser,TSubclassOf<UDamageType>  DamageTypeClass)
		{
			_this->ApplyPointDamage(DamagedActor,BaseDamage,*HitFromDirection,*HitInfo,EventInstigator,DamageCauser,DamageTypeClass);
		...
		static void BindFunctions()
		{
			...
			mono_add_internal_call("UnrealEngine.UGameplayStatics::PredictProjectilePath",(const void*)PredictProjectilePath);
			...
			mono_add_internal_call("UnrealEngine.UGameplayStatics::BeginDeferredActorSpawnFromClass",(const void*)BeginDeferredActorSpawnFromClass);
