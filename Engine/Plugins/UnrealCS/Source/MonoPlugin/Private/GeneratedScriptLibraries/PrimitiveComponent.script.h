...
namespace UnrealEngine
{
	class _UPrimitiveComponent
	{
		...
		static void SetRenderInMono(UPrimitiveComponent* _this,int32 bValue)
		{
			_this->SetRenderInMono(bValue>0?true:false);
		...
		static int32 K2_LineTraceComponent(UPrimitiveComponent* _this,FVector* TraceStart,FVector* TraceEnd,int32 bTraceComplex,int32 bShowTrace,FVector* HitLocation,FVector* HitNormal,MonoString** BoneName,FHitResult* OutHit)
		{
			FName BoneName_temp;
			bool ___ret = _this->K2_LineTraceComponent(*TraceStart,*TraceEnd,bTraceComplex>0?true:false,bShowTrace>0?true:false,*HitLocation,*HitNormal,BoneName_temp,*OutHit);
			return ___ret?1:0;
		...
		static void BindFunctions()
		{
			...
			mono_add_internal_call("UnrealEngine.UPrimitiveComponent::SetRenderInMono",(const void*)SetRenderInMono);
