...
namespace UnrealEngine
{
	class _UActorComponent
	{
		...
		static void SetAutoActivate(UActorComponent* _this,int32 bNewAutoActivate)
		{
			_this->SetAutoActivate(bNewAutoActivate>0?true:false);
		...
		static void BindFunctions()
		{
			...
			mono_add_internal_call("UnrealEngine.UActorComponent::SetAutoActivate",(const void*)SetAutoActivate);
