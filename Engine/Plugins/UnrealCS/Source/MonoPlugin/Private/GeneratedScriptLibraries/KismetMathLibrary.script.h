...
namespace UnrealEngine
{
	class _UKismetMathLibrary
	{
		...
		static int32 IsPointInBoxWithTransform(UKismetMathLibrary* _this,FVector* Point,FTransform* BoxWorldTransform,FVector* BoxExtent)
		{
			bool ___ret = _this->IsPointInBoxWithTransform(*Point,*BoxWorldTransform,*BoxExtent);
			return ___ret?1:0;
			
		}
		static int32 IsPointInBox(UKismetMathLibrary* _this,FVector* Point,FVector* BoxOrigin,FVector* BoxExtent)
		{
			bool ___ret = _this->IsPointInBox(*Point,*BoxOrigin,*BoxExtent);
			return ___ret?1:0;
		...
		static FBox2D MakeBox2D(UKismetMathLibrary* _this,FVector2D* Min,FVector2D* Max)
		{
			FBox2D ___ret = _this->MakeBox2D(*Min,*Max);
			return ___ret;
			
		}
		static FBox MakeBox(UKismetMathLibrary* _this,FVector* Min,FVector* Max)
		{
			FBox ___ret = _this->MakeBox(*Min,*Max);
			return ___ret;
		...
		static FVector Conv_IntVectorToVector(UKismetMathLibrary* _this,FIntVector* InIntVector)
		{
			FVector ___ret = _this->Conv_IntVectorToVector(*InIntVector);
			return ___ret;
		...
		static FIntVector Conv_IntToIntVector(UKismetMathLibrary* _this,int32 InInt)
		{
			FIntVector ___ret = _this->Conv_IntToIntVector(InInt);
			return ___ret;
		...
		static FVector GetReflectionVector(UKismetMathLibrary* _this,FVector* Direction,FVector* SurfaceNormal)
		{
			FVector ___ret = _this->GetReflectionVector(*Direction,*SurfaceNormal);
			return ___ret;
		...
		static FIntVector FTruncVector(UKismetMathLibrary* _this,FVector* InVector)
		{
			FIntVector ___ret = _this->FTruncVector(*InVector);
			return ___ret;
		...
		static void BindFunctions()
		{
			...
			mono_add_internal_call("UnrealEngine.UKismetMathLibrary::IsPointInBoxWithTransform",(const void*)IsPointInBoxWithTransform);
			mono_add_internal_call("UnrealEngine.UKismetMathLibrary::IsPointInBox",(const void*)IsPointInBox);
			...
			mono_add_internal_call("UnrealEngine.UKismetMathLibrary::MakeBox2D",(const void*)MakeBox2D);
			mono_add_internal_call("UnrealEngine.UKismetMathLibrary::MakeBox",(const void*)MakeBox);
			...
			mono_add_internal_call("UnrealEngine.UKismetMathLibrary::Conv_IntVectorToVector",(const void*)Conv_IntVectorToVector);
			...
			mono_add_internal_call("UnrealEngine.UKismetMathLibrary::Conv_IntToIntVector",(const void*)Conv_IntToIntVector);
			...
			mono_add_internal_call("UnrealEngine.UKismetMathLibrary::GetReflectionVector",(const void*)GetReflectionVector);
			...
			mono_add_internal_call("UnrealEngine.UKismetMathLibrary::FTruncVector",(const void*)FTruncVector);
