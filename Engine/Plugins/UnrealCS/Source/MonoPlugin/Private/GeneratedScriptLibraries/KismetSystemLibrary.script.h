...
namespace UnrealEngine
{
	...
	{
		static MonoString* GetCommandLine(UKismetSystemLibrary* _this)
		{
			FString ___ret = _this->GetCommandLine();
		...
		static int32 CapsuleTraceMultiForObjects(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* Start,FVector* End,float Radius,float HalfHeight,MonoArray* ObjectTypes,int32 bTraceComplex,MonoArray* ActorsToIgnore,int32 DrawDebugType,MonoArray** OutHits,int32 bIgnoreSelf,FLinearColor* TraceColor,FLinearColor* TraceHitColor,float DrawTime)
		{
			...
			bool ___ret = _this->CapsuleTraceMultiForObjects(WorldContextObject,*Start,*End,Radius,HalfHeight,MonoArrayToTArray<TEnumAsByte<EObjectTypeQuery>>(ObjectTypes),bTraceComplex>0?true:false,MonoArrayToTArray<AActor*>(ActorsToIgnore),(TEnumAsByte<EDrawDebugTrace::Type>)DrawDebugType,OutHits_temp,bIgnoreSelf>0?true:false,*TraceColor,*TraceHitColor,DrawTime);
			return ___ret?1:0;
			*OutHits=TArrayToMonoArray(OutHits_temp,"UnrealEngine.FHitResult,UnrealEngine");
			
		}
		static int32 CapsuleTraceSingleForObjects(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* Start,FVector* End,float Radius,float HalfHeight,MonoArray* ObjectTypes,int32 bTraceComplex,MonoArray* ActorsToIgnore,int32 DrawDebugType,FHitResult* OutHit,int32 bIgnoreSelf,FLinearColor* TraceColor,FLinearColor* TraceHitColor,float DrawTime)
		{
			bool ___ret = _this->CapsuleTraceSingleForObjects(WorldContextObject,*Start,*End,Radius,HalfHeight,MonoArrayToTArray<TEnumAsByte<EObjectTypeQuery>>(ObjectTypes),bTraceComplex>0?true:false,MonoArrayToTArray<AActor*>(ActorsToIgnore),(TEnumAsByte<EDrawDebugTrace::Type>)DrawDebugType,*OutHit,bIgnoreSelf>0?true:false,*TraceColor,*TraceHitColor,DrawTime);
			return ___ret?1:0;
			
		}
		static int32 BoxTraceMultiForObjects(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* Start,FVector* End,FVector* HalfSize,FRotator* Orientation,MonoArray* ObjectTypes,int32 bTraceComplex,MonoArray* ActorsToIgnore,int32 DrawDebugType,MonoArray** OutHits,int32 bIgnoreSelf,FLinearColor* TraceColor,FLinearColor* TraceHitColor,float DrawTime)
		{
			TArray<FHitResult> OutHits_temp;
			bool ___ret = _this->BoxTraceMultiForObjects(WorldContextObject,*Start,*End,*HalfSize,*Orientation,MonoArrayToTArray<TEnumAsByte<EObjectTypeQuery>>(ObjectTypes),bTraceComplex>0?true:false,MonoArrayToTArray<AActor*>(ActorsToIgnore),(TEnumAsByte<EDrawDebugTrace::Type>)DrawDebugType,OutHits_temp,bIgnoreSelf>0?true:false,*TraceColor,*TraceHitColor,DrawTime);
			return ___ret?1:0;
			*OutHits=TArrayToMonoArray(OutHits_temp,"UnrealEngine.FHitResult,UnrealEngine");
			
		}
		static int32 BoxTraceSingleForObjects(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* Start,FVector* End,FVector* HalfSize,FRotator* Orientation,MonoArray* ObjectTypes,int32 bTraceComplex,MonoArray* ActorsToIgnore,int32 DrawDebugType,FHitResult* OutHit,int32 bIgnoreSelf,FLinearColor* TraceColor,FLinearColor* TraceHitColor,float DrawTime)
		{
			bool ___ret = _this->BoxTraceSingleForObjects(WorldContextObject,*Start,*End,*HalfSize,*Orientation,MonoArrayToTArray<TEnumAsByte<EObjectTypeQuery>>(ObjectTypes),bTraceComplex>0?true:false,MonoArrayToTArray<AActor*>(ActorsToIgnore),(TEnumAsByte<EDrawDebugTrace::Type>)DrawDebugType,*OutHit,bIgnoreSelf>0?true:false,*TraceColor,*TraceHitColor,DrawTime);
			return ___ret?1:0;
			
		}
		static int32 SphereTraceMultiForObjects(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* Start,FVector* End,float Radius,MonoArray* ObjectTypes,int32 bTraceComplex,MonoArray* ActorsToIgnore,int32 DrawDebugType,MonoArray** OutHits,int32 bIgnoreSelf,FLinearColor* TraceColor,FLinearColor* TraceHitColor,float DrawTime)
		{
			TArray<FHitResult> OutHits_temp;
			bool ___ret = _this->SphereTraceMultiForObjects(WorldContextObject,*Start,*End,Radius,MonoArrayToTArray<TEnumAsByte<EObjectTypeQuery>>(ObjectTypes),bTraceComplex>0?true:false,MonoArrayToTArray<AActor*>(ActorsToIgnore),(TEnumAsByte<EDrawDebugTrace::Type>)DrawDebugType,OutHits_temp,bIgnoreSelf>0?true:false,*TraceColor,*TraceHitColor,DrawTime);
			return ___ret?1:0;
			*OutHits=TArrayToMonoArray(OutHits_temp,"UnrealEngine.FHitResult,UnrealEngine");
			
		}
		static int32 SphereTraceSingleForObjects(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* Start,FVector* End,float Radius,MonoArray* ObjectTypes,int32 bTraceComplex,MonoArray* ActorsToIgnore,int32 DrawDebugType,FHitResult* OutHit,int32 bIgnoreSelf,FLinearColor* TraceColor,FLinearColor* TraceHitColor,float DrawTime)
		{
			bool ___ret = _this->SphereTraceSingleForObjects(WorldContextObject,*Start,*End,Radius,MonoArrayToTArray<TEnumAsByte<EObjectTypeQuery>>(ObjectTypes),bTraceComplex>0?true:false,MonoArrayToTArray<AActor*>(ActorsToIgnore),(TEnumAsByte<EDrawDebugTrace::Type>)DrawDebugType,*OutHit,bIgnoreSelf>0?true:false,*TraceColor,*TraceHitColor,DrawTime);
			return ___ret?1:0;
		...
		static int32 CapsuleTraceMulti(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* Start,FVector* End,float Radius,float HalfHeight,int32 TraceChannel,int32 bTraceComplex,MonoArray* ActorsToIgnore,int32 DrawDebugType,MonoArray** OutHits,int32 bIgnoreSelf,FLinearColor* TraceColor,FLinearColor* TraceHitColor,float DrawTime)
		{
			TArray<FHitResult> OutHits_temp;
			bool ___ret = _this->CapsuleTraceMulti(WorldContextObject,*Start,*End,Radius,HalfHeight,(TEnumAsByte<ETraceTypeQuery>)TraceChannel,bTraceComplex>0?true:false,MonoArrayToTArray<AActor*>(ActorsToIgnore),(TEnumAsByte<EDrawDebugTrace::Type>)DrawDebugType,OutHits_temp,bIgnoreSelf>0?true:false,*TraceColor,*TraceHitColor,DrawTime);
			return ___ret?1:0;
			*OutHits=TArrayToMonoArray(OutHits_temp,"UnrealEngine.FHitResult,UnrealEngine");
			
		}
		static int32 CapsuleTraceSingle(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* Start,FVector* End,float Radius,float HalfHeight,int32 TraceChannel,int32 bTraceComplex,MonoArray* ActorsToIgnore,int32 DrawDebugType,FHitResult* OutHit,int32 bIgnoreSelf,FLinearColor* TraceColor,FLinearColor* TraceHitColor,float DrawTime)
		{
			bool ___ret = _this->CapsuleTraceSingle(WorldContextObject,*Start,*End,Radius,HalfHeight,(TEnumAsByte<ETraceTypeQuery>)TraceChannel,bTraceComplex>0?true:false,MonoArrayToTArray<AActor*>(ActorsToIgnore),(TEnumAsByte<EDrawDebugTrace::Type>)DrawDebugType,*OutHit,bIgnoreSelf>0?true:false,*TraceColor,*TraceHitColor,DrawTime);
			return ___ret?1:0;
			
		}
		static int32 BoxTraceMulti(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* Start,FVector* End,FVector* HalfSize,FRotator* Orientation,int32 TraceChannel,int32 bTraceComplex,MonoArray* ActorsToIgnore,int32 DrawDebugType,MonoArray** OutHits,int32 bIgnoreSelf,FLinearColor* TraceColor,FLinearColor* TraceHitColor,float DrawTime)
		{
			TArray<FHitResult> OutHits_temp;
			bool ___ret = _this->BoxTraceMulti(WorldContextObject,*Start,*End,*HalfSize,*Orientation,(TEnumAsByte<ETraceTypeQuery>)TraceChannel,bTraceComplex>0?true:false,MonoArrayToTArray<AActor*>(ActorsToIgnore),(TEnumAsByte<EDrawDebugTrace::Type>)DrawDebugType,OutHits_temp,bIgnoreSelf>0?true:false,*TraceColor,*TraceHitColor,DrawTime);
			return ___ret?1:0;
			*OutHits=TArrayToMonoArray(OutHits_temp,"UnrealEngine.FHitResult,UnrealEngine");
			
		}
		static int32 BoxTraceSingle(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* Start,FVector* End,FVector* HalfSize,FRotator* Orientation,int32 TraceChannel,int32 bTraceComplex,MonoArray* ActorsToIgnore,int32 DrawDebugType,FHitResult* OutHit,int32 bIgnoreSelf,FLinearColor* TraceColor,FLinearColor* TraceHitColor,float DrawTime)
		{
			bool ___ret = _this->BoxTraceSingle(WorldContextObject,*Start,*End,*HalfSize,*Orientation,(TEnumAsByte<ETraceTypeQuery>)TraceChannel,bTraceComplex>0?true:false,MonoArrayToTArray<AActor*>(ActorsToIgnore),(TEnumAsByte<EDrawDebugTrace::Type>)DrawDebugType,*OutHit,bIgnoreSelf>0?true:false,*TraceColor,*TraceHitColor,DrawTime);
			return ___ret?1:0;
			
		}
		static int32 SphereTraceMulti(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* Start,FVector* End,float Radius,int32 TraceChannel,int32 bTraceComplex,MonoArray* ActorsToIgnore,int32 DrawDebugType,MonoArray** OutHits,int32 bIgnoreSelf,FLinearColor* TraceColor,FLinearColor* TraceHitColor,float DrawTime)
		{
			TArray<FHitResult> OutHits_temp;
			bool ___ret = _this->SphereTraceMulti(WorldContextObject,*Start,*End,Radius,(TEnumAsByte<ETraceTypeQuery>)TraceChannel,bTraceComplex>0?true:false,MonoArrayToTArray<AActor*>(ActorsToIgnore),(TEnumAsByte<EDrawDebugTrace::Type>)DrawDebugType,OutHits_temp,bIgnoreSelf>0?true:false,*TraceColor,*TraceHitColor,DrawTime);
			return ___ret?1:0;
			*OutHits=TArrayToMonoArray(OutHits_temp,"UnrealEngine.FHitResult,UnrealEngine");
			
		}
		static int32 SphereTraceSingle(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* Start,FVector* End,float Radius,int32 TraceChannel,int32 bTraceComplex,MonoArray* ActorsToIgnore,int32 DrawDebugType,FHitResult* OutHit,int32 bIgnoreSelf,FLinearColor* TraceColor,FLinearColor* TraceHitColor,float DrawTime)
		{
			bool ___ret = _this->SphereTraceSingle(WorldContextObject,*Start,*End,Radius,(TEnumAsByte<ETraceTypeQuery>)TraceChannel,bTraceComplex>0?true:false,MonoArrayToTArray<AActor*>(ActorsToIgnore),(TEnumAsByte<EDrawDebugTrace::Type>)DrawDebugType,*OutHit,bIgnoreSelf>0?true:false,*TraceColor,*TraceHitColor,DrawTime);
			return ___ret?1:0;
			
		}
		static int32 LineTraceMulti(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* Start,FVector* End,int32 TraceChannel,int32 bTraceComplex,MonoArray* ActorsToIgnore,int32 DrawDebugType,MonoArray** OutHits,int32 bIgnoreSelf,FLinearColor* TraceColor,FLinearColor* TraceHitColor,float DrawTime)
		{
			TArray<FHitResult> OutHits_temp;
			bool ___ret = _this->LineTraceMulti(WorldContextObject,*Start,*End,(TEnumAsByte<ETraceTypeQuery>)TraceChannel,bTraceComplex>0?true:false,MonoArrayToTArray<AActor*>(ActorsToIgnore),(TEnumAsByte<EDrawDebugTrace::Type>)DrawDebugType,OutHits_temp,bIgnoreSelf>0?true:false,*TraceColor,*TraceHitColor,DrawTime);
			return ___ret?1:0;
			*OutHits=TArrayToMonoArray(OutHits_temp,"UnrealEngine.FHitResult,UnrealEngine");
			
		}
		static int32 LineTraceSingle(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* Start,FVector* End,int32 TraceChannel,int32 bTraceComplex,MonoArray* ActorsToIgnore,int32 DrawDebugType,FHitResult* OutHit,int32 bIgnoreSelf,FLinearColor* TraceColor,FLinearColor* TraceHitColor,float DrawTime)
		{
			bool ___ret = _this->LineTraceSingle(WorldContextObject,*Start,*End,(TEnumAsByte<ETraceTypeQuery>)TraceChannel,bTraceComplex>0?true:false,MonoArrayToTArray<AActor*>(ActorsToIgnore),(TEnumAsByte<EDrawDebugTrace::Type>)DrawDebugType,*OutHit,bIgnoreSelf>0?true:false,*TraceColor,*TraceHitColor,DrawTime);
			return ___ret?1:0;
			
		}
		static int32 ComponentOverlapComponents(UKismetSystemLibrary* _this,UPrimitiveComponent* Component,FTransform* ComponentTransform,MonoArray* ObjectTypes,UClass* ComponentClassFilter,MonoArray* ActorsToIgnore,MonoArray** OutComponents)
		{
			TArray<UPrimitiveComponent*> OutComponents_temp;
			bool ___ret = _this->ComponentOverlapComponents(Component,*ComponentTransform,MonoArrayToTArray<TEnumAsByte<EObjectTypeQuery>>(ObjectTypes),ComponentClassFilter,MonoArrayToTArray<AActor*>(ActorsToIgnore),OutComponents_temp);
			return ___ret?1:0;
			*OutComponents=TArrayToMonoArray(OutComponents_temp,"System.IntPtr,mscorlib");
			
		}
		static int32 ComponentOverlapActors(UKismetSystemLibrary* _this,UPrimitiveComponent* Component,FTransform* ComponentTransform,MonoArray* ObjectTypes,UClass* ActorClassFilter,MonoArray* ActorsToIgnore,MonoArray** OutActors)
		{
			TArray<AActor*> OutActors_temp;
			bool ___ret = _this->ComponentOverlapActors(Component,*ComponentTransform,MonoArrayToTArray<TEnumAsByte<EObjectTypeQuery>>(ObjectTypes),ActorClassFilter,MonoArrayToTArray<AActor*>(ActorsToIgnore),OutActors_temp);
			return ___ret?1:0;
			*OutActors=TArrayToMonoArray(OutActors_temp,"System.IntPtr,mscorlib");
			
		}
		static int32 CapsuleOverlapComponents(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* CapsulePos,float Radius,float HalfHeight,MonoArray* ObjectTypes,UClass* ComponentClassFilter,MonoArray* ActorsToIgnore,MonoArray** OutComponents)
		{
			TArray<UPrimitiveComponent*> OutComponents_temp;
			bool ___ret = _this->CapsuleOverlapComponents(WorldContextObject,*CapsulePos,Radius,HalfHeight,MonoArrayToTArray<TEnumAsByte<EObjectTypeQuery>>(ObjectTypes),ComponentClassFilter,MonoArrayToTArray<AActor*>(ActorsToIgnore),OutComponents_temp);
			return ___ret?1:0;
			*OutComponents=TArrayToMonoArray(OutComponents_temp,"System.IntPtr,mscorlib");
			
		}
		static int32 CapsuleOverlapActors(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* CapsulePos,float Radius,float HalfHeight,MonoArray* ObjectTypes,UClass* ActorClassFilter,MonoArray* ActorsToIgnore,MonoArray** OutActors)
		{
			TArray<AActor*> OutActors_temp;
			bool ___ret = _this->CapsuleOverlapActors(WorldContextObject,*CapsulePos,Radius,HalfHeight,MonoArrayToTArray<TEnumAsByte<EObjectTypeQuery>>(ObjectTypes),ActorClassFilter,MonoArrayToTArray<AActor*>(ActorsToIgnore),OutActors_temp);
			return ___ret?1:0;
			*OutActors=TArrayToMonoArray(OutActors_temp,"System.IntPtr,mscorlib");
			
		}
		static int32 BoxOverlapComponents(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* BoxPos,FVector* Extent,MonoArray* ObjectTypes,UClass* ComponentClassFilter,MonoArray* ActorsToIgnore,MonoArray** OutComponents)
		{
			TArray<UPrimitiveComponent*> OutComponents_temp;
			bool ___ret = _this->BoxOverlapComponents(WorldContextObject,*BoxPos,*Extent,MonoArrayToTArray<TEnumAsByte<EObjectTypeQuery>>(ObjectTypes),ComponentClassFilter,MonoArrayToTArray<AActor*>(ActorsToIgnore),OutComponents_temp);
			return ___ret?1:0;
			*OutComponents=TArrayToMonoArray(OutComponents_temp,"System.IntPtr,mscorlib");
			
		}
		static int32 BoxOverlapActors(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* BoxPos,FVector* BoxExtent,MonoArray* ObjectTypes,UClass* ActorClassFilter,MonoArray* ActorsToIgnore,MonoArray** OutActors)
		{
			TArray<AActor*> OutActors_temp;
			bool ___ret = _this->BoxOverlapActors(WorldContextObject,*BoxPos,*BoxExtent,MonoArrayToTArray<TEnumAsByte<EObjectTypeQuery>>(ObjectTypes),ActorClassFilter,MonoArrayToTArray<AActor*>(ActorsToIgnore),OutActors_temp);
			return ___ret?1:0;
			*OutActors=TArrayToMonoArray(OutActors_temp,"System.IntPtr,mscorlib");
			
		}
		static int32 SphereOverlapComponents(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* SpherePos,float SphereRadius,MonoArray* ObjectTypes,UClass* ComponentClassFilter,MonoArray* ActorsToIgnore,MonoArray** OutComponents)
		{
			TArray<UPrimitiveComponent*> OutComponents_temp;
			bool ___ret = _this->SphereOverlapComponents(WorldContextObject,*SpherePos,SphereRadius,MonoArrayToTArray<TEnumAsByte<EObjectTypeQuery>>(ObjectTypes),ComponentClassFilter,MonoArrayToTArray<AActor*>(ActorsToIgnore),OutComponents_temp);
			return ___ret?1:0;
			*OutComponents=TArrayToMonoArray(OutComponents_temp,"System.IntPtr,mscorlib");
			
		}
		static int32 SphereOverlapActors(UKismetSystemLibrary* _this,UObject* WorldContextObject,FVector* SpherePos,float SphereRadius,MonoArray* ObjectTypes,UClass* ActorClassFilter,MonoArray* ActorsToIgnore,MonoArray** OutActors)
		{
			TArray<AActor*> OutActors_temp;
			bool ___ret = _this->SphereOverlapActors(WorldContextObject,*SpherePos,SphereRadius,MonoArrayToTArray<TEnumAsByte<EObjectTypeQuery>>(ObjectTypes),ActorClassFilter,MonoArrayToTArray<AActor*>(ActorsToIgnore),OutActors_temp);
			return ___ret?1:0;
			*OutActors=TArrayToMonoArray(OutActors_temp,"System.IntPtr,mscorlib");
		...
		static MonoString* GetDeviceId(UKismetSystemLibrary* _this)
		{
			FString ___ret = _this->GetDeviceId();
			return FStringToMonoString(___ret);
		...
		{
			mono_add_internal_call("UnrealEngine.UKismetSystemLibrary::GetCommandLine",(const void*)GetCommandLine);
			...
			mono_add_internal_call("UnrealEngine.UKismetSystemLibrary::CapsuleTraceMulti",(const void*)CapsuleTraceMulti);
			mono_add_internal_call("UnrealEngine.UKismetSystemLibrary::CapsuleTraceSingle",(const void*)CapsuleTraceSingle);
			...
			mono_add_internal_call("UnrealEngine.UKismetSystemLibrary::SphereTraceMulti",(const void*)SphereTraceMulti);
			mono_add_internal_call("UnrealEngine.UKismetSystemLibrary::SphereTraceSingle",(const void*)SphereTraceSingle);
			mono_add_internal_call("UnrealEngine.UKismetSystemLibrary::LineTraceMulti",(const void*)LineTraceMulti);
			mono_add_internal_call("UnrealEngine.UKismetSystemLibrary::LineTraceSingle",(const void*)LineTraceSingle);
			mono_add_internal_call("UnrealEngine.UKismetSystemLibrary::ComponentOverlapComponents",(const void*)ComponentOverlapComponents);
			mono_add_internal_call("UnrealEngine.UKismetSystemLibrary::ComponentOverlapActors",(const void*)ComponentOverlapActors);
			mono_add_internal_call("UnrealEngine.UKismetSystemLibrary::CapsuleOverlapComponents",(const void*)CapsuleOverlapComponents);
			mono_add_internal_call("UnrealEngine.UKismetSystemLibrary::CapsuleOverlapActors",(const void*)CapsuleOverlapActors);
			mono_add_internal_call("UnrealEngine.UKismetSystemLibrary::BoxOverlapComponents",(const void*)BoxOverlapComponents);
			mono_add_internal_call("UnrealEngine.UKismetSystemLibrary::BoxOverlapActors",(const void*)BoxOverlapActors);
			mono_add_internal_call("UnrealEngine.UKismetSystemLibrary::SphereOverlapComponents",(const void*)SphereOverlapComponents);
			mono_add_internal_call("UnrealEngine.UKismetSystemLibrary::SphereOverlapActors",(const void*)SphereOverlapActors);
			...
			mono_add_internal_call("UnrealEngine.UKismetSystemLibrary::GetDeviceId",(const void*)GetDeviceId);
