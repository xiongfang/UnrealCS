...
namespace UnrealEngine
{
	class _UMovementComponent
	{
		...
		static void BindFunctions()
		{
			...
			mono_add_internal_call("UnrealEngine.UMovementComponent::GetPlaneConstraintAxisSetting",(const void*)GetPlaneConstraintAxisSetting);
			mono_add_internal_call("UnrealEngine.UMovementComponent::SetPlaneConstraintAxisSetting",(const void*)SetPlaneConstraintAxisSetting);
