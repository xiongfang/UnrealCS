...
namespace UnrealEngine
{
	class _UUserWidget
	{
		...
		static void SetOwningPlayer(UUserWidget* _this,APlayerController* LocalPlayerController)
		{
			_this->SetOwningPlayer(LocalPlayerController);
		...
		static void BindFunctions()
		{
			...
			mono_add_internal_call("UnrealEngine.UUserWidget::SetOwningPlayer",(const void*)SetOwningPlayer);
