...
namespace UnrealEngine
{
	class _USkeletalMeshComponent
	{
		...
		static void SetUpdateAnimationInEditor(USkeletalMeshComponent* _this,int32 NewUpdateState)
		{
			_this->SetUpdateAnimationInEditor(NewUpdateState>0?true:false);
		...
		static int32 IsClothingSimulationSuspended(USkeletalMeshComponent* _this)
		{
			bool ___ret = _this->IsClothingSimulationSuspended();
			return ___ret?1:0;
			
		}
		static void ResumeClothingSimulation(USkeletalMeshComponent* _this)
		{
			_this->ResumeClothingSimulation();
			
		}
		static void SuspendClothingSimulation(USkeletalMeshComponent* _this)
		{
			_this->SuspendClothingSimulation();
		...
		static void SnapshotPose(USkeletalMeshComponent* _this,FPoseSnapshot* Snapshot)
		{
		...
		static void BindFunctions()
		{
			...
			mono_add_internal_call("UnrealEngine.USkeletalMeshComponent::SetUpdateAnimationInEditor",(const void*)SetUpdateAnimationInEditor);
			...
			mono_add_internal_call("UnrealEngine.USkeletalMeshComponent::IsClothingSimulationSuspended",(const void*)IsClothingSimulationSuspended);
			mono_add_internal_call("UnrealEngine.USkeletalMeshComponent::ResumeClothingSimulation",(const void*)ResumeClothingSimulation);
			mono_add_internal_call("UnrealEngine.USkeletalMeshComponent::SuspendClothingSimulation",(const void*)SuspendClothingSimulation);
			...
			mono_add_internal_call("UnrealEngine.USkeletalMeshComponent::SnapshotPose",(const void*)SnapshotPose);
