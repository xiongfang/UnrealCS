...
namespace UnrealEngine
{
	class _UWidget
	{
		...
		static FGeometry GetCachedGeometry(UWidget* _this)
		{
			FGeometry ___ret = _this->GetCachedGeometry();
			return ___ret;
		...
		static void BindFunctions()
		{
			...
			mono_add_internal_call("UnrealEngine.UWidget::GetCachedGeometry",(const void*)GetCachedGeometry);
