...
namespace UnrealEngine
{
	class _AActor
	{
		...
		static MonoString* GetAttachParentSocketName(AActor* _this)
		{
			FName ___ret = _this->GetAttachParentSocketName();
			return FNameToMonoString(___ret);
			
		}
		static AActor* GetAttachParentActor(AActor* _this)
		{
			AActor* ___ret = _this->GetAttachParentActor();
			return ___ret;
		...
		static void BindFunctions()
		{
			...
			mono_add_internal_call("UnrealEngine.AActor::GetAttachParentSocketName",(const void*)GetAttachParentSocketName);
			mono_add_internal_call("UnrealEngine.AActor::GetAttachParentActor",(const void*)GetAttachParentActor);
