...
namespace UnrealEngine
{
	class _UTextBlock
	{
		...
		static void SetMinDesiredWidth(UTextBlock* _this,float InMinDesiredWidth)
		{
		...
		static void BindFunctions()
		{
			...
			mono_add_internal_call("UnrealEngine.UTextBlock::SetMinDesiredWidth",(const void*)SetMinDesiredWidth);
