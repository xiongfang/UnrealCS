...
namespace UnrealEngine
{
	class _UPhysicsConstraintComponent
	{
		...
		static void SetAngularDriveParams(UPhysicsConstraintComponent* _this,float InSpring,float InDamping,float InForceLimit)
		{
			_this->SetAngularDriveParams(InSpring,InDamping,InForceLimit);
		...
		static void SetLinearDriveParams(UPhysicsConstraintComponent* _this,float InSpring,float InDamping,float InForceLimit)
		{
			_this->SetLinearDriveParams(InSpring,InDamping,InForceLimit);
		...
		static void SetAngularVelocityDrive(UPhysicsConstraintComponent* _this,int32 bEnableSwingDrive,int32 bEnableTwistDrive)
		{
			_this->SetAngularVelocityDrive(bEnableSwingDrive>0?true:false,bEnableTwistDrive>0?true:false);
			
		}
		static void SetAngularOrientationDrive(UPhysicsConstraintComponent* _this,int32 bEnableSwingDrive,int32 bEnableTwistDrive)
		{
			_this->SetAngularOrientationDrive(bEnableSwingDrive>0?true:false,bEnableTwistDrive>0?true:false);
		...
		static void BindFunctions()
		{
			...
			mono_add_internal_call("UnrealEngine.UPhysicsConstraintComponent::SetAngularVelocityDrive",(const void*)SetAngularVelocityDrive);
			mono_add_internal_call("UnrealEngine.UPhysicsConstraintComponent::SetAngularOrientationDrive",(const void*)SetAngularOrientationDrive);
