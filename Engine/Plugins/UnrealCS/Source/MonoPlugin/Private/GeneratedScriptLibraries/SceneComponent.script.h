...
namespace UnrealEngine
{
	class _USceneComponent
	{
		...
		static void BindFunctions()
		{
			...
			mono_add_internal_call("UnrealEngine.USceneComponent::K2_DetachFromComponent",(const void*)K2_DetachFromComponent);
			mono_add_internal_call("UnrealEngine.USceneComponent::DetachFromParent",(const void*)DetachFromParent);
			mono_add_internal_call("UnrealEngine.USceneComponent::K2_AttachToComponent",(const void*)K2_AttachToComponent);
