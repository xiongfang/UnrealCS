...
namespace UnrealEngine
{
	class _UImage
	{
		...
		static void SetBrushFromTextureDynamic(UImage* _this,UTexture2DDynamic* Texture,int32 bMatchSize)
		{
			_this->SetBrushFromTextureDynamic(Texture,bMatchSize>0?true:false);
		...
		static void BindFunctions()
		{
			...
			mono_add_internal_call("UnrealEngine.UImage::SetBrushFromTextureDynamic",(const void*)SetBrushFromTextureDynamic);
