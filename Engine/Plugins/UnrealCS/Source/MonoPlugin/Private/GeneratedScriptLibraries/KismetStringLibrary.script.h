...
namespace UnrealEngine
{
	class _UKismetStringLibrary
	{
		...
		static MonoString* BuildString_IntVector(UKismetStringLibrary* _this,MonoString* AppendTo,MonoString* Prefix,FIntVector* InIntVector,MonoString* Suffix)
		{
			FString AppendTo_temp=MonoStringToFString(AppendTo);
			FString Prefix_temp=MonoStringToFString(Prefix);
			FString Suffix_temp=MonoStringToFString(Suffix);
			FString ___ret = _this->BuildString_IntVector(AppendTo_temp,Prefix_temp,*InIntVector,Suffix_temp);
			return FStringToMonoString(___ret);
		...
		static MonoString* Conv_IntVectorToString(UKismetStringLibrary* _this,FIntVector* InIntVec)
		{
			FString ___ret = _this->Conv_IntVectorToString(*InIntVec);
			return FStringToMonoString(___ret);
		...
		static void BindFunctions()
		{
			...
			mono_add_internal_call("UnrealEngine.UKismetStringLibrary::BuildString_IntVector",(const void*)BuildString_IntVector);
			...
			mono_add_internal_call("UnrealEngine.UKismetStringLibrary::Conv_IntVectorToString",(const void*)Conv_IntVectorToString);
